...
public class Office2PDF
{
     ...
     * @param converter
     */
    public static void converterFile(File inputFile, String outputFilePath_end, String inputFilePath, String outputFilePath, OpenOfficeDocumentConverter converter) {
...
//        Size A3 = new Size(29700, 42000);
        DocumentFormat format = new DocumentFormat("Microsoft Excel", DocumentFamily.SPREADSHEET, "application/vnd.ms-excel", "xls");
